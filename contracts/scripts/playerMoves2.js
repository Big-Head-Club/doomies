...
async function main() {
  ...
  col.cyan("Moves for Turn Two...");

  const moves = [
    {tokenId: 1, dx: 1, dy: 0}, // move down
    {tokenId: 3, dx: 0, dy: 1}, // move right
    {tokenId: 4, dx: -1, dy: 0}, // move up
    {tokenId: 5, dx: -1, dy: 0}, // move up
    {tokenId: 6, dx: -1, dy: 0}, // move up
    {tokenId: 7, dx: -1, dy: -1}, // move up and left
    {tokenId: 8, dx: -1, dy: -1}, // move up and left
    {tokenId: 9, dx: -1, dy: -1}, // move up and left
    {tokenId: 10, dx: -1, dy: 0}, // move up
    {tokenId: 11, dx: 0, dy: -1}, //  move left
    {tokenId: 12, dx: 1, dy: 0}, // move down
    {tokenId: 13, dx: 1, dy: 0}, // move down
    {tokenId: 14, dx: 1, dy: 0}, // move down
    {tokenId: 15, dx: 1, dy: 1}, // move down and right
    {tokenId: 16, dx: 1, dy: 1}, // move down and right
  ];
